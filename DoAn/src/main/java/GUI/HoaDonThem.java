...
public class HoaDonThem extends javax.swing.JFrame {
  ...
  public int stt = 0;
    ...
    public int getRowbyId(String id) {
      for (int i = 0; i < tableCTHD.getRowCount(); i++) {
        ...
        if (Integer.parseInt(id) == Integer.parseInt(tableCTHD.getValueAt(i, 1).toString())) return i;
      }
      return -1;
    }
  ...
  private void initComponents() {
    ...
    tableThanhvien.setShowGrid(false);
    ...
    getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 550, 592));
    ...
    private void btnLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuActionPerformed
        ...
        try {
          int maKh;
          if (mathanhvienTxt.getText().isEmpty()) maKh = 0;
          else maKh = Integer.parseInt(mathanhvienTxt.getText());
