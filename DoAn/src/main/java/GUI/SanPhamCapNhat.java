...
//    public SanPhamBLL SanPhamBLL = new SanPhamBLL();
    ...
    jPanel2Layout.setVerticalGroup(
      ...
      .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
          ...
          .addComponent(tenLoaiTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
        .addGap(42, 42, 42)
  ...
  private void btnCapnhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCapnhatActionPerformed
      ...
      try {
          ...
          if (tenSp.isEmpty() || hangSx.isEmpty() || mota.isEmpty() || loaiSp.isEmpty() || giaBan.isEmpty() || tgbh.isEmpty()) {
              JOptionPane.showMessageDialog(rootPane, "Không thành công, vui lồng kiểm tra lại thông tin", "Lỗi", JOptionPane.ERROR_MESSAGE);
              return;
          }
          boolean result = SanPhamBLL.updateSanPham(maSp, tenSp, Integer.parseInt(giaBan), Integer.parseInt(tgbh), hangSx, mota, maLsp);
          if (result) {
              dispose();
  ...
  public javax.swing.JComboBox<LoaiSP> tenLoaiTxt;
