...
public class SanPhamThem extends javax.swing.JFrame {
    ...
    private void BTThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTThemActionPerformed
        ...
        try {
          ...
          boolean result = SanPhamBLL.insertSanPham(tenSp, Integer.parseInt(giaBan), Integer.parseInt(tgbh), hangSx, soluong, mota, Integer.parseInt(maLsp.get(selectedIndex)));
          if (result) {
