...
//        DefaultRowSorter sorter = ((DefaultRowSorter)JTableNhanVien.getRowSorter()); 
...
//    }
    ...
    private void BTXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTXoaActionPerformed
        // TODO add your handling code here:
//        System.out.println(JTableNhanVien.getSelectedRow());
//        System.out.println(JTableNhanVien.getValueAt(JTableNhanVien.getSelectedRow(), 0).toString());
        ...
        if (reply == JOptionPane.YES_OPTION) {
            ...
            int indexTB = JTableNhanVien.getSelectedRow();
            System.out.println(indexTB);
            // Lay du lieu tu dong dang chon.
            String maNV = JTableNhanVien.getValueAt(indexTB, 0).toString();
            // Delete dong du lieu
            if (NhanVienBLL.deleteNhanVien(maNV)) {
                ...
                JOptionPane.showMessageDialog(rootPane, "Xóa không thành công, nhân viên này thuộc 1 hóa đơn nào đó", "Lỗi", JOptionPane.ERROR_MESSAGE);
            }
        }
