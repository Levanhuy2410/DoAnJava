 ...
 * @author USER
 */
public class PhieuXuatThem extends javax.swing.JFrame {

    /**
     * Creates new form QuanLySanPham
     */
    public PhieuXuatThem() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Tên Sản Phẩm", "Số Lượng Xuất ", "Loại Sản Phẩm"
            }
        ) {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 0, 900, 610));
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 580, 610));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PhieuXuatThem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PhieuXuatThem().setVisible(true);
            }
        });
    }
