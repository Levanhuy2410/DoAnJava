...
public class ThanhVienCapNhat extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BTCapNhat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/icons8-replace-35.png"))); // NOI18N
    ...
    private void BTCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTCapNhatActionPerformed
        ...
        int DIEMTV = Integer.parseInt(diemTV.getText().trim());
        String SDT = sdt.getText().trim();
        String EMAIL = email.getText().trim();
        if (ThanhVienBLL.updateThanhVien(MATV, TENTV, LOAITV, SDT, EMAIL, DIEMTV)){
            Object[] data = {TENTV, LOAITV, SDT, EMAIL, DIEMTV};
            // Update row đc chọn
    ...
    public javax.swing.JTextField diemTV;
